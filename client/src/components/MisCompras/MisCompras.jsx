...
import { getUser, getCompras, getAllUsers } from "../../redux/actions/UsersAction";
...
function MisCompras() {
  ...
  const userLogueado = users.find(e => e.id === logueado.id)
  if(userLogueado){
  ...
  return (
   ...
   {comprasDelUsuario.length === 0 && <div>Su historial de compras está vacío</div>} 
