...
{/*                         <Cards
            ...
            <h4>{"10.99"}</h4>
            <h4>{"Revlon Ultra HD Matte Lipcolor gives you lightweight, high definition velvety matte color. It has a moisturizing, velvety \nfeel with a 100% wax-free, gel formula. Features: Creamy mango and whipped vanilla fragrance \nPlush velvety applicator Shade Range: (top row, left to right / bottom row, left to right) Devotion, Obsession, Addiction, Temptation / Flirtation, Love, Seduction, Passion"}</h4>
